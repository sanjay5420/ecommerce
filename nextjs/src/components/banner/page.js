...
const Banner = () => {
    return (
        <div className=' md:py-20'>
            <div className='md:w-[80%] md:ml-auto md:mr-auto w-[90%]  ml-auto mr-auto flex flex-col-reverse md:flex-row p-10 md:py-16 justify-center items-center mt-10 md:mt-0 bg-gradient-to-l from-orange-300 to-gray-50 rounded-3xl'>
