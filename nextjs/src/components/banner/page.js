...
const Banner = () => {
    return (
        <div className=' md:py-20'>
            <div className='section flex flex-col-reverse md:flex-row p-10 md:py-16 justify-center items-center mt-10 md:mt-0 bg-gradient-to-l from-orange-200 to-gray-50 rounded-3xl'>
                ...
                <div className='w-full md:w-[50%] flex justify-end items-center'>
                    <img className='' src='/banner.png' width={400}/>
                </div>
            </div>
        </div>
    )
